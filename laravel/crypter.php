...
class Crypter {
	 ...
	 * @var string
	 */
	public static $cipher = 'AES-256-CBC';//MCRYPT_RIJNDAEL_256;
	 ...
	 * @var string
	 */
	public static $mode = null; //Sicnce mcrypt is deprecated //MCRYPT_MODE_CBC;
	...
	public static function encrypt($value)
	{
		...
		$ciphertext_raw = openssl_encrypt($value, static::$cipher, static::key(), $options=OPENSSL_RAW_DATA, $iv);
	...
	public static function decrypt($value)
	{
		...
		$original_plaintext = openssl_decrypt($ciphertext_raw, static::$cipher, static::key(), $options=OPENSSL_RAW_DATA, $iv);
		$calcmac = hash_hmac('sha256', $ciphertext_raw, static::key(), $as_binary=true);

...
{   
    //С тех пор как функция deprecated он возвращал true, но не позволял пользоваться
	return false;//return function_exists('get_magic_quotes_gpc') and get_magic_quotes_gpc();
}

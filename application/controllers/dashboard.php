...
class Dashboard_Controller extends Base_Controller {
    ...
    public function get_tasks() {
		...
		$clients = Client::where('created_at', '>=', $from_date)->where('created_at', '<=', $to_date)->group_by('current_status')->group_by('chdate')->order_by('cnt', 'desc')->get(array('count(current_status) as cnt', 'current_status', 'date(created_at) as chdate'));
